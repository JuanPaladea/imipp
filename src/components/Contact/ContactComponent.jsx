...
const ContactComponent = () => {
  ...
  return (
    ...
    >
      <section className="container mx-auto text-gray-600 body-font relative py-12 px-5">
        <div className="flex flex-col py-4">
          <div className="h-1 bg-gray-200 rounded overflow-hidden">
            <div className="w-full lg:w-24 h-full bg-[#009cde]"></div>
          </div>
          <div className="flex flex-wrap sm:flex-row flex-col py-6">
            <h1 className="sm:w-2/5 text-gray-900 text-3xl tracking-tight font-extrabold mb-2 sm:mb-0">Contacto</h1>
            <p className="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">Ponte en contacto con nosotros</p>
          </div>
        </div>
          ...
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <p className="mt-1">Gallo 1330 - Hospital de Niños "Dr. Ricardo Gutierrez", Pabellón Q.</p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                <a className="text-indigo-500 leading-relaxed">imipp@conicet.gov.ar</a>
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">TELÉFONO</h2>
                <p className="leading-relaxed">11-4962-9138</p>
              </div>
            </div>
          </div>
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Contacto</h2>
            <p className="leading-relaxed mb-5 text-gray-600">Completa el formulario para ponerte en contacto con nosotros</p>
            <form ref={form} onSubmit={handleSubmit}>
              ...
              <motion.button
                whileTap={{ scale: 0.9 }}
                type="submit"
                className="text-white bg-[#009cde] border-0 py-2 px-6 focus:outline-none hover:bg-opacity-90 rounded text-lg"
              >
                Contáctanos
              </motion.button>
            </form>
