          ...
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <Link to="/FISH" class="bg-gray-100 rounded-lg">
                <motion.img 
                whileTap={{ scale: 0.9 }}
                class="h-40 rounded-lg shadow w-full object-cover object-center mb-6 hover:scale-105 hover:opacity-85 transition-all" src="https://i.imgur.com/wtUPJUU.jpg" alt="content"/>
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <Link to="/Secuenciacion" class="bg-gray-100 rounded-lg">
                <motion.img 
                whileTap={{ scale: 0.9 }}
                class="h-40 rounded-lg shadow w-full object-cover object-center mb-6 hover:scale-105 hover:opacity-85 transition-all" src="https://i.imgur.com/Miz8HDK.png" alt="content"/>
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <Link to="/IHQ" class="bg-gray-100 rounded-lg">
                <motion.img 
                whileTap={{ scale: 0.9 }}
                class="h-40 rounded-lg shadow w-full object-cover object-center mb-6 hover:scale-105 hover:opacity-85 transition all" src="https://i.imgur.com/1DQkgDP.jpg" alt="content"/>
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
              <Link to="/Curso-biologia-molecular" class="bg-gray-100 rounded-lg">
                <motion.img 
                whileTap={{ scale: 0.9 }}
                class="h-40 rounded-lg shadow w-full object-cover object-center mb-6 hover:scale-105 hover:opacity-85 transition-all" src="https://i.imgur.com/1WbnJd3.jpg" alt="content"/>
