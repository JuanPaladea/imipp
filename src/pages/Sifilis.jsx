...
const Sifilis = () => {
  const {resultado, loading} = useUnico('LineasDeInvestigacion/s1rVSM4a6ovPJvT9BJMt/Sifilis', 'npuc8cCoaOigH3v5yhLT')
  const {resultados: integrantes, loading: loadingIntegrantes} = useCollection('LineasDeInvestigacion/s1rVSM4a6ovPJvT9BJMt/Sifilis/npuc8cCoaOigH3v5yhLT/Integrantes')
  const {resultados: publicaciones, loading: loadingPublicaciones} = useCollection('LineasDeInvestigacion/s1rVSM4a6ovPJvT9BJMt/Sifilis/npuc8cCoaOigH3v5yhLT/Publicaciones')
